...
namespace PoorEngine.Particles
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        private Texture2D texture
        {
            get
            {
                return TextureManager.GetTexture(textureFilename).BaseTexture as Texture2D;
            }
        }
        ...
        protected override void LoadContent()
        {
            ...
            TextureManager.AddTexture(new PoorTexture(textureFilename), textureFilename);
        ...
        public void AddParticles(Vector2 where)
        {
            ...
            int numParticles = 
                CalcHelper.Random.Next(minNumParticles, maxNumParticles);
        ...
        protected virtual void InitializeParticle(Particle p, Vector2 where)
        {
            ...
            float lifetime =
				CalcHelper.RandomBetween(minLifetime, maxLifetime);
            float scale =
				CalcHelper.RandomBetween(minScale, maxScale);
            float rotationSpeed =
				CalcHelper.RandomBetween(minRotationSpeed, maxRotationSpeed);
        ...
        {
            float angle = CalcHelper.RandomBetween(0, MathHelper.TwoPi);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            // initializeConstants
            ScreenManager.SpriteBatch.Begin(SpriteSortMode.BackToFront, blendState);
